...
const useTypingText = (words: string[], keySpeed = 1000, maxPauseAmount = 10, finishAtEnd = false) => {
    ...
    }, [currentWord, wordIndex, keySpeed, words, maxPauseAmount, isStopped, finishAtEnd]);
